...
def test_ce_net_vessel():
    ...
    jsonfile = '/data/yangzhigang/RCFSNet/dataset/paris_build/test_CAPTIONS_parisBuild_road.json'
    ...
    solver.load('./weights/Instruct_FHNetparis_build_best_iou.th')
    # target = '/data/guoxuejun/yangjialin/CE-Net/submits/log_U_Net/'
    target = './submits/Instruct_FHNet_parisroadBuild20/'
    ...
    for i, name in enumerate(val):
        ...
        ground_truth_path = os.path.join(gt_root, name.split('_')[0] + '_labels.jpg')
